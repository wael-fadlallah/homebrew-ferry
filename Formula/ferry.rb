class Ferry < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/wael-fadlallah/ferry/releases/download/v#{version}/ferry_Darwin_arm64.tar.gz"
      sha256 "57d668dcbeb8588ec531601d8f8c08ba64b76a6f6235c4edf11f3beda7635a44"
    else
      url "https://github.com/wael-fadlallah/ferry/releases/download/v#{version}/ferry_Darwin_x86_64.tar.gz"
